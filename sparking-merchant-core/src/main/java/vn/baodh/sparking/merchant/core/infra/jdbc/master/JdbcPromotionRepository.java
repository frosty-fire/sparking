...
import vn.baodh.sparking.merchant.core.domain.repository.PromotionRepository;
...
public class JdbcPromotionRepository implements PromotionRepository {
  ...
  public List<VoucherModel> getVouchers(int limit) throws Exception {
    ...
    VoucherModel voucherModel1 = new VoucherModel()
        ...
        .setImageUrl("https://firebasestorage.googleapis.com/v0/b/sparking-app.appspot.com/o/voucher%2Ffree-parking.jpeg?alt=media&token=0d73c2af-6b33-4192-8a3c-13503b7c69d1");
    VoucherModel voucherModel2 = new VoucherModel()
        .setVoucherId("2")
        .setTitle("[Eastpoint Mall] Khuyến mãi đố xe vào cuối tuần.")
        .setImageUrl("https://firebasestorage.googleapis.com/v0/b/sparking-app.appspot.com/o/voucher%2Feastpoint_mall.jpeg?alt=media&token=62dcd6a6-e374-42f8-bbbb-4deacb0de456");
    VoucherModel voucherModel3 = new VoucherModel()
        .setVoucherId("3")
        .setTitle("[Hype Parking] Miễn phí đỗ xe trong 8 giờ liên tiếp.")
        .setImageUrl("https://firebasestorage.googleapis.com/v0/b/sparking-app.appspot.com/o/voucher%2Fhype_parking.webp?alt=media&token=84a81be4-8df8-41e0-9f16-450b38c10b5e");
