...
@Data
public class PayMonthCardPayload implements PayLoad {
  ...
  public PayMonthCardPayload getPayLoadInfo(Map<String, ?> params) {
    PayMonthCardPayload payload = new PayMonthCardPayload();
